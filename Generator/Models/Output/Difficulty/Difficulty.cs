namespace Generator.Models.Output.Difficulty
{
    ...
    public class Lay
    {
        public Lay(bool cHECK_SHOOT_WHEN_LAYING, double dELTA_LAY_CHECK, double dELTA_GETUP, double dELTA_AFTER_GETUP,
            double cLEAR_POINTS_OF_SCARE_SEC, double mAX_LAY_TIME, double dELTA_WANT_LAY_CHECL_SEC, double aTTACK_LAY_CHANCE,
            double dIST_TO_COVER_TO_LAY, double dIST_TO_COVER_TO_LAY_SQRT, double dIST_GRASS_TERRAIN_SQRT, double dIST_ENEMY_NULL_DANGER_LAY,
            double dIST_ENEMY_NULL_DANGER_LAY_SQRT, double dIST_ENEMY_GETUP_LAY, double dIST_ENEMY_GETUP_LAY_SQRT, double dIST_ENEMY_CAN_LAY,
            double dIST_ENEMY_CAN_LAY_SQRT, double lAY_AIM, double mIN_CAN_LAY_DIST_SQRT, double mIN_CAN_LAY_DIST,
            double mAX_CAN_LAY_DIST_SQRT, double mAX_CAN_LAY_DIST, double lAY_CHANCE_DANGER, int dAMAGE_TIME_TO_GETUP)
        {
        ...
        public double DELTA_LAY_CHECK { get; set; }
        public double DELTA_GETUP { get; set; }
        public double DELTA_AFTER_GETUP { get; set; }
        public double CLEAR_POINTS_OF_SCARE_SEC { get; set; }
        public double MAX_LAY_TIME { get; set; }
        public double DELTA_WANT_LAY_CHECL_SEC { get; set; }
        public double ATTACK_LAY_CHANCE { get; set; }
        ...
        public double DIST_ENEMY_NULL_DANGER_LAY { get; set; }
        public double DIST_ENEMY_NULL_DANGER_LAY_SQRT { get; set; }
        public double DIST_ENEMY_GETUP_LAY { get; set; }
        public double DIST_ENEMY_GETUP_LAY_SQRT { get; set; }
        public double DIST_ENEMY_CAN_LAY { get; set; }
        public double DIST_ENEMY_CAN_LAY_SQRT { get; set; }
        public double LAY_AIM { get; set; }
        public double MIN_CAN_LAY_DIST_SQRT { get; set; }
        public double MIN_CAN_LAY_DIST { get; set; }
        public double MAX_CAN_LAY_DIST_SQRT { get; set; }
        public double MAX_CAN_LAY_DIST { get; set; }
        public double LAY_CHANCE_DANGER { get; set; }
    ...
    public class Aiming
    {
        ...
        public double PANIC_TIME { get; set; }
        public int RECALC_MUST_TIME { get; set; }
        public double DAMAGE_PANIC_TIME { get; set; }
        public double DANGER_UP_POINT { get; set; }
        public double MAX_AIMING_UPGRADE_BY_TIME { get; set; }
        public double DAMAGE_TO_DISCARD_AIM_0_100 { get; set; }
        ...
        public double FIRST_CONTACT_ADD_CHANCE_100 { get; set; }
        public double BASE_HIT_AFFECTION_DELAY_SEC { get; set; }
        public double BASE_HIT_AFFECTION_MIN_ANG { get; set; }
        public double BASE_HIT_AFFECTION_MAX_ANG { get; set; }
        public double BASE_SHIEF { get; set; }
        public double SCATTERING_HAVE_DAMAGE_COEF { get; set; }
        ...
        public double DIST_TO_SHOOT_TO_CENTER { get; set; }
        public double DIST_TO_SHOOT_NO_OFFSET { get; set; }
        public double SHPERE_FRIENDY_FIRE_SIZE { get; set; }
        public double COEF_IF_MOVE { get; set; }
        public double TIME_COEF_IF_MOVE { get; set; }
        public double BOT_MOVE_IF_DELTA { get; set; }
        public double NEXT_SHOT_MISS_CHANCE_100 { get; set; }
        public double NEXT_SHOT_MISS_Y_OFFSET { get; set; }
        public double ANYTIME_LIGHT_WHEN_AIM_100 { get; set; }
        public double ANY_PART_SHOOT_TIME { get; set; }
        public double WEAPON_ROOT_OFFSET { get; set; }
        public double MIN_DAMAGE_TO_GET_HIT_AFFETS { get; set; }
    ...
    public class Look
    {
        public Look(double oLD_TIME_POINT, double wAIT_NEW_SENSOR, double wAIT_NEW__LOOK_SENSOR, double lOOK_AROUND_DELTA,
            double mAX_VISION_GRASS_METERS, double mAX_VISION_GRASS_METERS_FLARE, double mAX_VISION_GRASS_METERS_OPT,
            double mAX_VISION_GRASS_METERS_FLARE_OPT, double lightOnVisionDistance, double fAR_DISTANCE, double farDeltaTimeSec,
            double mIDDLE_DIST, double middleDeltaTimeSec, double closeDeltaTimeSec, double pOSIBLE_VISION_SPACE, double gOAL_TO_FULL_DISSAPEAR,
            ...
            double vISIBLE_DISNACE_WITH_LIGHT, double eNEMY_LIGHT_ADD, double eNEMY_LIGHT_START_DIST, bool cAN_LOOK_TO_WALL, double dIST_NOT_TO_IGNORE_WALL,
            double dIST_CHECK_WALL, double lOOK_LAST_POSENEMY_IF_NO_DANGER_SEC, double mIN_LOOK_AROUD_TIME, bool oPTIMIZE_TO_ONLY_BODY)
        {
        ...
        public double OLD_TIME_POINT { get; set; }
        ...
        public double MAX_VISION_GRASS_METERS_FLARE { get; set; }
        public double MAX_VISION_GRASS_METERS_OPT { get; set; }
        public double MAX_VISION_GRASS_METERS_FLARE_OPT { get; set; }
        public double LightOnVisionDistance { get; set; }
        public double FAR_DISTANCE { get; set; }
        public double FarDeltaTimeSec { get; set; }
        public double MIDDLE_DIST { get; set; }
        public double MiddleDeltaTimeSec { get; set; }
        ...
        public double VISIBLE_DISNACE_WITH_LIGHT { get; set; }
        public double ENEMY_LIGHT_ADD { get; set; }
        public double ENEMY_LIGHT_START_DIST { get; set; }
        public bool CAN_LOOK_TO_WALL { get; set; }
        public double DIST_NOT_TO_IGNORE_WALL { get; set; }
        public double DIST_CHECK_WALL { get; set; }
        public double LOOK_LAST_POSENEMY_IF_NO_DANGER_SEC { get; set; }
        public double MIN_LOOK_AROUD_TIME { get; set; }
        public bool OPTIMIZE_TO_ONLY_BODY { get; set; }
    }

    public class Shoot
    {
        public Shoot(double rECOIL_TIME_NORMALIZE, double rECOIL_PER_METER, double mAX_RECOIL_PER_METER, double hORIZONT_RECOIL_COEF,
            double wAIT_NEXT_SINGLE_SHOT, double wAIT_NEXT_SINGLE_SHOT_LONG_MAX, double wAIT_NEXT_SINGLE_SHOT_LONG_MIN, double mARKSMAN_DIST_SEK_COEF,
            double fINGER_HOLD_SINGLE_SHOT, double bASE_AUTOMATIC_TIME, double aUTOMATIC_FIRE_SCATTERING_COEF, double cHANCE_TO_CHANGE_TO_AUTOMATIC_FIRE_100,
            double fAR_DIST_ENEMY, int sHOOT_FROM_COVER, double fAR_DIST_ENEMY_SQR, double mAX_DIST_COEF, double rECOIL_DELTA_PRESS, double rUN_DIST_NO_AMMO,
            double rUN_DIST_NO_AMMO_SQRT, int cAN_SHOOTS_TIME_TO_AMBUSH, double nOT_TO_SEE_ENEMY_TO_WANT_RELOAD_PERCENT,
            double nOT_TO_SEE_ENEMY_TO_WANT_RELOAD_SEC, double rELOAD_PECNET_NO_ENEMY, double cHANCE_TO_CHANGE_WEAPON,
            double cHANCE_TO_CHANGE_WEAPON_WITH_HELMET, double lOW_DIST_TO_CHANGE_WEAPON, double fAR_DIST_TO_CHANGE_WEAPON, double sUPPRESS_BY_SHOOT_TIME,
            int sUPPRESS_TRIGGERS_DOWN, double wAIT_NEXT_STATIONARY_GRENADE, double fINGER_HOLD_STATIONARY_GRENADE)
        {
        ...
        public double RECOIL_TIME_NORMALIZE { get; set; }
        ...
        public double MARKSMAN_DIST_SEK_COEF { get; set; }
    ...
    public class Move
    {
        ...
        public double BASE_ROTATE_SPEED { get; set; }
    ...
    public class Grenade
    {
        public Grenade(double dELTA_NEXT_ATTEMPT_FROM_COVER, double dELTA_NEXT_ATTEMPT, double mIN_DIST_NOT_TO_THROW, double nEAR_DELTA_THROW_TIME_SEC, double mIN_THROW_GRENADE_DIST, double mIN_THROW_GRENADE_DIST_SQRT, double mIN_DIST_NOT_TO_THROW_SQR, double rUN_AWAY, double rUN_AWAY_SQR, double aDD_GRENADE_AS_DANGER, double aDD_GRENADE_AS_DANGER_SQR, double cHANCE_TO_NOTIFY_ENEMY_GR_100, double grenadePerMeter, double rEQUEST_DIST_MUST_THROW_SQRT, double rEQUEST_DIST_MUST_THROW, int bEWARE_TYPE, double sHOOT_TO_SMOKE_CHANCE_100, double cHANCE_RUN_FLASHED_100, double mAX_FLASHED_DIST_TO_SHOOT, double mAX_FLASHED_DIST_TO_SHOOT_SQRT, double fLASH_GRENADE_TIME_COEF, double sIZE_SPOTTED_COEF, double bE_ATTENTION_COEF, double tIME_SHOOT_TO_FLASH, double cLOSE_TO_SMOKE_TO_SHOOT, double cLOSE_TO_SMOKE_TO_SHOOT_SQRT, double cLOSE_TO_SMOKE_TIME_DELTA, double sMOKE_CHECK_DELTA, double dELTA_GRENADE_START_TIME, double aMBUSH_IF_SMOKE_IN_ZONE_100, double aMBUSH_IF_SMOKE_RETURN_TO_ATTACK_SEC, bool nO_RUN_FROM_AI_GRENADES, double mAX_THROW_POWER, double mIN_THROW_DIST_PERCENT_0_1, double grenadePrecision, bool sTOP_WHEN_THROW_GRENADE, double wAIT_TIME_TURN_AWAY, double sMOKE_SUPPRESS_DELTA, double dAMAGE_GRENADE_SUPPRESS_DELTA, double sTUN_SUPPRESS_DELTA, bool cHEAT_START_GRENADE_PLACE, bool cAN_THROW_STRAIGHT_CONTACT, double sTRAIGHT_CONTACT_DELTA_SEC, int aNG_TYPE)
        {
            ...
            MIN_THROW_DIST_PERCENT_0_1 = mIN_THROW_DIST_PERCENT_0_1;
        ...
        public double DELTA_NEXT_ATTEMPT_FROM_COVER { get; set; }
        public double DELTA_NEXT_ATTEMPT { get; set; }
        public double MIN_DIST_NOT_TO_THROW { get; set; }
        public double NEAR_DELTA_THROW_TIME_SEC { get; set; }
        public double MIN_THROW_GRENADE_DIST { get; set; }
        public double MIN_THROW_GRENADE_DIST_SQRT { get; set; }
        public double MIN_DIST_NOT_TO_THROW_SQR { get; set; }
        public double RUN_AWAY { get; set; }
        public double RUN_AWAY_SQR { get; set; }
        public double ADD_GRENADE_AS_DANGER { get; set; }
        public double ADD_GRENADE_AS_DANGER_SQR { get; set; }
        public double CHANCE_TO_NOTIFY_ENEMY_GR_100 { get; set; }
        public double GrenadePerMeter { get; set; }
        public double REQUEST_DIST_MUST_THROW_SQRT { get; set; }
        public double REQUEST_DIST_MUST_THROW { get; set; }
        public int BEWARE_TYPE { get; set; }
        public double SHOOT_TO_SMOKE_CHANCE_100 { get; set; }
        public double CHANCE_RUN_FLASHED_100 { get; set; }
        public double MAX_FLASHED_DIST_TO_SHOOT { get; set; }
        public double MAX_FLASHED_DIST_TO_SHOOT_SQRT { get; set; }
        public double FLASH_GRENADE_TIME_COEF { get; set; }
        public double SIZE_SPOTTED_COEF { get; set; }
        public double BE_ATTENTION_COEF { get; set; }
        public double TIME_SHOOT_TO_FLASH { get; set; }
        public double CLOSE_TO_SMOKE_TO_SHOOT { get; set; }
        public double CLOSE_TO_SMOKE_TO_SHOOT_SQRT { get; set; }
        public double CLOSE_TO_SMOKE_TIME_DELTA { get; set; }
        public double SMOKE_CHECK_DELTA { get; set; }
        public double DELTA_GRENADE_START_TIME { get; set; }
        public double AMBUSH_IF_SMOKE_IN_ZONE_100 { get; set; }
        public double AMBUSH_IF_SMOKE_RETURN_TO_ATTACK_SEC { get; set; }
        ...
        public double SMOKE_SUPPRESS_DELTA { get; set; }
        public double DAMAGE_GRENADE_SUPPRESS_DELTA { get; set; }
        public double STUN_SUPPRESS_DELTA { get; set; }
        public bool CHEAT_START_GRENADE_PLACE { get; set; }
        public bool CAN_THROW_STRAIGHT_CONTACT { get; set; }
        public double STRAIGHT_CONTACT_DELTA_SEC { get; set; }
        public int ANG_TYPE { get; set; }
    }

    public class Change
    {
        public Change(double sMOKE_VISION_DIST, double sMOKE_GAIN_SIGHT, double sMOKE_SCATTERING, double sMOKE_PRECICING, double sMOKE_HEARING, double sMOKE_ACCURATY, double sMOKE_LAY_CHANCE, double fLASH_VISION_DIST, double fLASH_GAIN_SIGHT, double fLASH_SCATTERING, double fLASH_PRECICING, double fLASH_HEARING, double fLASH_ACCURATY, double fLASH_LAY_CHANCE, double sTUN_HEARING)
        {
        ...
        public double SMOKE_HEARING { get; set; }
    ...
    public class Cover
    {
        ...
        public double RETURN_TO_ATTACK_AFTER_AMBUSH_MIN { get; set; }
        public double RETURN_TO_ATTACK_AFTER_AMBUSH_MAX { get; set; }
        public double SOUND_TO_GET_SPOTTED { get; set; }
        public double TIME_TO_MOVE_TO_COVER { get; set; }
        public double MAX_DIST_OF_COVER { get; set; }
        public double CHANGE_RUN_TO_COVER_SEC { get; set; }
        public double CHANGE_RUN_TO_COVER_SEC_GREANDE { get; set; }
        public double MIN_DIST_TO_ENEMY { get; set; }
        public double DIST_CANT_CHANGE_WAY { get; set; }
        public double DIST_CHECK_SFETY { get; set; }
        public double TIME_CHECK_SAFE { get; set; }
        public double HIDE_TO_COVER_TIME { get; set; }
        public double MAX_DIST_OF_COVER_SQR { get; set; }
        public double DIST_CANT_CHANGE_WAY_SQR { get; set; }
        public double SPOTTED_COVERS_RADIUS { get; set; }
        public double LOOK_LAST_ENEMY_POS_MOVING { get; set; }
        public double LOOK_TO_HIT_POINT_IF_LAST_ENEMY { get; set; }
        public double LOOK_LAST_ENEMY_POS_LOOKAROUND { get; set; }
        public int OFFSET_LOOK_ALONG_WALL_ANG { get; set; }
        public double SPOTTED_GRENADE_RADIUS { get; set; }
        public double MAX_SPOTTED_TIME_SEC { get; set; }
        public double WAIT_INT_COVER_FINDING_ENEMY { get; set; }
        public double CLOSE_DIST_POINT_SQRT { get; set; }
        public double DELTA_SEEN_FROM_COVE_LAST_POS { get; set; }
        public bool MOVE_TO_COVER_WHEN_TARGET { get; set; }
        public bool RUN_COVER_IF_CAN_AND_NO_ENEMIES { get; set; }
        public double SPOTTED_GRENADE_TIME { get; set; }
        public bool DEPENDS_Y_DIST_TO_BOT { get; set; }
        public double RUN_IF_FAR { get; set; }
        public double RUN_IF_FAR_SQRT { get; set; }
        public double STAY_IF_FAR { get; set; }
        public double STAY_IF_FAR_SQRT { get; set; }
        ...
        public double DOG_FIGHT_AFTER_LEAVE { get; set; }
        public bool NOT_LOOK_AT_WALL_IS_DANGER { get; set; }
        public double MIN_DEFENCE_LEVEL { get; set; }
        public double GOOD_DIST_TO_POINT_COEF { get; set; }
        public double ENEMY_DIST_TO_GO_OUT { get; set; }
        public double STATIONARY_WEAPON_NO_ENEMY_GETUP { get; set; }
    ...
    public class Patrol
    {
        ...
        public double DEAD_BODY_LOOK_PERIOD { get; set; }
        public double LOOK_TIME_BASE { get; set; }
        ...
        public double RESERVE_TIME_STAY { get; set; }
        public double FRIEND_SEARCH_SEC { get; set; }
        public double TALK_DELAY { get; set; }
        public double MIN_TALK_DELAY { get; set; }
        public double TALK_DELAY_BIG { get; set; }
        public double CHANGE_WAY_TIME { get; set; }
        public double MIN_DIST_TO_CLOSE_TALK { get; set; }
        public double VISION_DIST_COEF_PEACE { get; set; }
        public double MIN_DIST_TO_CLOSE_TALK_SQR { get; set; }
        ...
        public double RESERVE_OUT_TIME { get; set; }
        public double CLOSE_TO_SELECT_RESERV_WAY { get; set; }
        public double MAX_YDIST_TO_START_WARN_REQUEST_TO_REQUESTER { get; set; }
    }

    public class Hearing
    {
        public Hearing(double bOT_CLOSE_PANIC_DIST, double cHANCE_TO_HEAR_SIMPLE_SOUND_0_1, double dISPERSION_COEF, double cLOSE_DIST, double fAR_DIST, double sOUND_DIR_DEEFREE, double dIST_PLACE_TO_FIND_POINT, double dEAD_BODY_SOUND_RAD, bool lOOK_ONLY_DANGER, double rESET_TIMER_DIST, double hEAR_DELAY_WHEN_PEACE, double hEAR_DELAY_WHEN_HAVE_SMT, double lOOK_ONLY_DANGER_DELTA)
        {
        ...
        public double BOT_CLOSE_PANIC_DIST { get; set; }
        public double CHANCE_TO_HEAR_SIMPLE_SOUND_0_1 { get; set; }
        public double DISPERSION_COEF { get; set; }
        public double CLOSE_DIST { get; set; }
        public double FAR_DIST { get; set; }
        public double SOUND_DIR_DEEFREE { get; set; }
        public double DIST_PLACE_TO_FIND_POINT { get; set; }
        public double DEAD_BODY_SOUND_RAD { get; set; }
        public bool LOOK_ONLY_DANGER { get; set; }
        public double RESET_TIMER_DIST { get; set; }
        public double HEAR_DELAY_WHEN_PEACE { get; set; }
        public double HEAR_DELAY_WHEN_HAVE_SMT { get; set; }
        public double LOOK_ONLY_DANGER_DELTA { get; set; }
    }
    ...
    public class Mind
    {
        ...
        public double TIME_TO_RUN_TO_COVER_CAUSE_SHOOT_SEC { get; set; }
        public double DAMAGE_REDUCTION_TIME_SEC { get; set; }
        public double MIN_DAMAGE_SCARE { get; set; }
        public double CHANCE_TO_RUN_CAUSE_DAMAGE_0_100 { get; set; }
        public double TIME_TO_FORGOR_ABOUT_ENEMY_SEC { get; set; }
        public double TIME_TO_FIND_ENEMY { get; set; }
        public double MAX_AGGRO_BOT_DIST { get; set; }
        public double HIT_POINT_DETECTION { get; set; }
        public double DANGER_POINT_CHOOSE_COEF { get; set; }
        ...
        public double DIST_TO_FOUND_SQRT { get; set; }
        public double MAX_AGGRO_BOT_DIST_SQR { get; set; }
        public double DIST_TO_STOP_RUN_ENEMY { get; set; }
        public bool CAN_TAKE_ITEMS { get; set; }
        public double ENEMY_LOOK_AT_ME_ANG { get; set; }
        public double MIN_START_AGGRESION_COEF { get; set; }
        public double MAX_START_AGGRESION_COEF { get; set; }
        public double BULLET_FEEL_DIST { get; set; }
        public double BULLET_FEEL_CLOSE_SDIST { get; set; }
        public double ATTACK_IMMEDIATLY_CHANCE_0_100 { get; set; }
        public double CHANCE_FUCK_YOU_ON_CONTACT_100 { get; set; }
        public double FRIEND_DEAD_AGR_LOW { get; set; }
        public double FRIEND_AGR_KILL { get; set; }
        public double LAST_ENEMY_LOOK_TO { get; set; }
        public bool CAN_RECIVE_PLAYER_REQUESTS { get; set; }
        public bool CAN_USE_MEDS { get; set; }
        public double SUSPETION_POINT_CHANCE_ADD100 { get; set; }
        public bool AMBUSH_WHEN_UNDER_FIRE { get; set; }
        public double AMBUSH_WHEN_UNDER_FIRE_TIME_RESIST { get; set; }
        ...
        public double FIND_COVER_TO_GET_POSITION_WITH_SHOOT { get; set; }
        public bool PROTECT_TIME_REAL { get; set; }
        public double CHANCE_SHOOT_WHEN_WARN_PLAYER_100 { get; set; }
        ...
        public double PROTECT_DELTA_HEAL_SEC { get; set; }
        public bool CAN_STAND_BY { get; set; }
        public bool CAN_THROW_REQUESTS { get; set; }
        public double GROUP_ANY_PHRASE_DELAY { get; set; }
        public double GROUP_EXACTLY_PHRASE_DELAY { get; set; }
        public double DIST_TO_ENEMY_YO_CAN_HEAL { get; set; }
        public double CHANCE_TO_STAY_WHEN_WARN_PLAYER_100 { get; set; }
        public double DOG_FIGHT_OUT { get; set; }
        public double DOG_FIGHT_IN { get; set; }
        public double SHOOT_INSTEAD_DOG_FIGHT { get; set; }
        public double PISTOL_SHOTGUN_AMBUSH_DIST { get; set; }
        public double STANDART_AMBUSH_DIST { get; set; }
        public double AI_POWER_COEF { get; set; }
        public double COVER_SECONDS_AFTER_LOSE_VISION { get; set; }
        public bool COVER_SELF_ALWAYS_IF_DAMAGED { get; set; }
        public double SEC_TO_MORE_DIST_TO_RUN { get; set; }
        public double HEAL_DELAY_SEC { get; set; }
        public double HIT_DELAY_WHEN_HAVE_SMT { get; set; }
        public double HIT_DELAY_WHEN_PEACE { get; set; }
    ...
    public class Boss
    {
        ...
        public double BOSS_DIST_TO_WARNING_SQRT { get; set; }
        public double BOSS_DIST_TO_WARNING_OUT { get; set; }
        public double BOSS_DIST_TO_WARNING_OUT_SQRT { get; set; }
        public double BOSS_DIST_TO_SHOOT { get; set; }
        public double BOSS_DIST_TO_SHOOT_SQRT { get; set; }
        public double CHANCE_TO_SEND_GRENADE_100 { get; set; }
        public double MAX_DIST_COVER_BOSS { get; set; }
        public double MAX_DIST_COVER_BOSS_SQRT { get; set; }
        public double MAX_DIST_DECIDER_TO_SEND { get; set; }
        public double MAX_DIST_DECIDER_TO_SEND_SQRT { get; set; }
        public double TIME_AFTER_LOSE { get; set; }
        public double TIME_AFTER_LOSE_DELTA { get; set; }
        public int PERSONS_SEND { get; set; }
        public double DELTA_SEARCH_TIME { get; set; }
        public bool COVER_TO_SEND { get; set; }
        public double WAIT_NO_ATTACK_SAVAGE { get; set; }
        public double CHANCE_USE_RESERVE_PATROL_100 { get; set; }
        public double KILLA_Y_DELTA_TO_BE_ENEMY_BOSS { get; set; }
        public double KILLA_DITANCE_TO_BE_ENEMY_BOSS { get; set; }
        public double KILLA_START_SEARCH_SEC { get; set; }
        public double KILLA_CONTUTION_TIME { get; set; }
        public double KILLA_CLOSE_ATTACK_DIST { get; set; }
        public double KILLA_MIDDLE_ATTACK_DIST { get; set; }
        public double KILLA_LARGE_ATTACK_DIST { get; set; }
        public double KILLA_SEARCH_METERS { get; set; }
        public double KILLA_DEF_DIST_SQRT { get; set; }
        public double KILLA_SEARCH_SEC_STOP_AFTER_COMING { get; set; }
        public double KILLA_DIST_TO_GO_TO_SUPPRESS { get; set; }
        public double KILLA_AFTER_GRENADE_SUPPRESS_DELAY { get; set; }
        public int KILLA_CLOSEATTACK_TIMES { get; set; }
        public double KILLA_CLOSEATTACK_DELAY { get; set; }
        public double KILLA_HOLD_DELAY { get; set; }
        public int KILLA_BULLET_TO_RELOAD { get; set; }
        public bool SHALL_WARN { get; set; }
        public double KOJANIY_DIST_WHEN_READY { get; set; }
        public double KOJANIY_DIST_TO_BE_ENEMY { get; set; }
        public double KOJANIY_MIN_DIST_TO_LOOT { get; set; }
        public double KOJANIY_MIN_DIST_TO_LOOT_SQRT { get; set; }
        public double KOJANIY_DIST_ENEMY_TOO_CLOSE { get; set; }
    ...
    public class Core
    {
        ...
        public double DamageCoeff { get; set; }
        public double HearingSense { get; set; }
        public bool CanRun { get; set; }
        public bool CanGrenade { get; set; }
        public string AimingType { get; set; }
        public double PistolFireDistancePref { get; set; }
        public double ShotgunFireDistancePref { get; set; }
        public double RifleFireDistancePref { get; set; }
    ...
    public class Scattering
    {
        ...
        public double ToLowBotAngularSpeed { get; set; }
        public double ToStopBotAngularSpeed { get; set; }
        ...
        public double DIST_FROM_OLD_POINT_TO_NOT_AIM { get; set; }
        public double DIST_FROM_OLD_POINT_TO_NOT_AIM_SQRT { get; set; }
        ...
        public double RecoilYMax { get; set; }
    }
